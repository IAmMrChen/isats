  ...
  <ul>
    <li v-for="(item, index) in name_data">
      ...
      <ul style="margin-left: 45px;">
        <li style="margin-top: 10px;cursor: pointer;" v-for="temp in item.examination_and_paper_ref"><a v-on:click="jump_to_examination(item.examination_id, temp.examination_paper_id)" style="color: black;font-style:italic;">@{{ temp.examination_paper.examination_paper_name }}</a></li>
      </ul>
    </li>
  </ul>
</div>
    ...
    (function ($) {
      var vm = new vue({
        ...
        methods: {
          ...
          jump_to_examination: function (examination_id, examination_paper_id) {
            location.href = "/examination/allexaminationquestions?examination_id=" + examination_id + "&examination_paper_id=" + examination_paper_id;
          }
        },
        created: function () {
